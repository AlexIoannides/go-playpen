...
//go:generate minimock -i alexioannides/go-playpen/learn-go-with-pocket-sized-projects/09-grpc-api/internal/habit.habitLister -o habit_lister_mock.go -n HabitListerMock -p mocks
