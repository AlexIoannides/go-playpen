...
//go:generate minimock -i alexioannides/go-playpen/learn-go-with-pocket-sized-projects/09-grpc-api/internal/habit.habitFinder -o habit_finder_mock.go -n HabitFinderMock -p mocks
